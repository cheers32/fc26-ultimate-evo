...
export const chemStyles: ChemStylesData = {
  ...
  Architect: { vision: 6, fkAccuracy: 3, shortPass: 9, longPass: 3, curve: 6, stamina: 6, strength: 9, aggression: 3 },
  Powerhouse: { vision: 9, shortPass: 6, longPass: 6, curve: 3, interceptions: 6, defAwareness: 3, standTackle: 9, slideTackle: 3 },
  Maestro: { shotPower: 6, longShots: 6, volleys: 3, penalties: 3, vision: 3, fkAccuracy: 3, shortPass: 3, longPass: 6, balance: 3, reactions: 6, ballControl: 6, dribbling: 6, composure: 3 },
